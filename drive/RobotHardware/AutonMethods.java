...
public class AutonMethods extends LinearOpMode{
    ...
    public void platformDown(long time, int stime, double aposition) {
        mechanisms.platformL.setPosition(aposition);
        mechanisms.platformR.setPosition(aposition);
        sleep(stime);
    }

    public void platformUp(long time, int stime, double aposition) {
        mechanisms.platformL.setPosition(aposition);
        mechanisms.platformR.setPosition(aposition);
        sleep(stime);
    }
