...
//                .build();
        ...
        while (opModeIsActive()) {
            ...
            autonMethods.platformDown(1000,1000, AutonMethods.platformMin);
            autonMethods.platformUp(1000,1000,AutonMethods.platformMax);
            autonMethods.StopLiftArm();
            autonMethods.sideArm(1000,1000,AutonMethods.sarmclose);
            autonMethods.sideArmGrip(1000,1000,0);
